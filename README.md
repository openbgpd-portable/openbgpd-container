...
For custom OCI images, the following build arguments can be passed:
  ...
  * `VERSION` - Version of the signed portability shim release tarball, defaults to `8.9`.
